...
public class User extends Model<User> {
    ...
    /**
     * 用于验证用户多久没有更新微信信息了，超过1周，将重新更新数据。
     */
    @TableField("token_mod_time")
    private Date tokenModTime;
    ...
    public void setUserSexual(String userSexual) {
    	this.userSexual = Integer.parseInt(userSexual);
    }
	...
	public Date getTokenModTime() {
		return tokenModTime;
	}

	public void setTokenModTime(Date tokenModTime) {
		this.tokenModTime = tokenModTime;
	}
